...
This analysis considered different social factors in the impact of average math score over time. The factors that appear to negatively impact average math score includes living in an urban setting and parents with a low educational level. Future studies may look into the interaction between parent-education level and socioeconomic status. As well as parent-educational level and location of living (urban vs rural). Many studies have shown a positive association between parent involvement and child's education, this may directly linked with the parent education level and the type of job the parent may work [@ParentInvolvement]. Finally, future studies may consider measuring student success in schools in forms beyond a math exam. This may include a holistic teacher and parent review on how their child is progressing in their education. 
